...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        participant_data = [
            {
                'name': 'Albania',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/ALB.png',
                'group': group_obj_dict['B']
                },
            {
                'name': 'Austria',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/AUT.png',
                'group': group_obj_dict['D']
                },
            {
                'name': 'Belgium',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/BEL.png',
                'group': group_obj_dict['E']
                },
            {
                'name': 'Croatia',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/CRO.png',
                'group': group_obj_dict['B']
                },
            {
                'name': 'Czechia',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/CZE.png',
                'group': group_obj_dict['F']
                },
            {
                'name': 'Denmark',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/DEN.png',
                'group': group_obj_dict['C']
                },
            {
                'name': 'England',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/ENG.png',
                'group': group_obj_dict['C']
                },
            {
                'name': 'France',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/FRA.png',
                'group': group_obj_dict['D']
                },
            {
                'name': 'Georgia',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/GEO.png',
                'group': group_obj_dict['F']
                },
            {
                'name': 'Germany',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/GER.png',
                'group': group_obj_dict['A']
                },
            {
                'name': 'Hungary',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/HUN.png',
                'group': group_obj_dict['A']
                },
            {
                'name': 'Italy',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/ITA.png',
                'group': group_obj_dict['B']
                },
            {
                'name': 'Netherlands',
            ...
            {
                'name': 'Poland',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/POL.png',
                'group': group_obj_dict['D']
                },
            {
                'name': 'Portugal',
            ...
            {
                'name': 'Romania',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/ROU.png',
                'group': group_obj_dict['E']
                },
            {
                'name': 'Scotland',
            ...
            {
                'name': 'Serbia',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/SRB.png',
                'group': group_obj_dict['C']
                },
            {
                'name': 'Slovakia',
            ...
            {
                'name': 'Spain',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/ESP.png',
                'group': group_obj_dict['B']
                },
            {
                'name': 'Switzerland',
            ...
            {
                'name': 'Türkiye',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/TUR.png',
                'group': group_obj_dict['F']
                },
            {
                'name': 'Ukraine',
                'flag': 'https://img.uefa.com/imgml/flags/50x50/UKR.png',
                'group': group_obj_dict['E']
                },
            ]
        ...
        match_data = [
            ...
            {
                'phase': '4',
                'match_time': '2024-07-05T17:00',
                'team_a_placeholder': 'W39',
                'team_b_placeholder': 'W37'
                },
            {
                'phase': '4',
                'match_time': '2024-07-05T20:00',
            ...
            {
                'phase': '4',
                'match_time': '2024-07-06T17:00',
                'team_a_placeholder': 'W40',
                'team_b_placeholder': 'W38'
                },
            {
                'phase': '4',
                'match_time': '2024-07-06T20:00',
